...
- 2026-09-16 19:55: merged to main and pushed after the one browser run (377 browser tests, 1,130 unit tests, all green). Helper restarted on the new code. Two doc tests that pinned text Ken removed today were updated to match.
