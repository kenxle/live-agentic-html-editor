...
- 2026-09-18: Ken flagged a banned single-side colored border on the overdue banner. It was already fixed in the shipped code (commit 51bfd2a, 2026-09-17); the pictures above were just stale, taken before that fix. Regenerated both from the current code and replaced them.
